(async () => {
    ...
    // data and map.
    const data = [
        ['fo', 110], ['um', 111], ['us', 12], ['jp', 13000], ['sc', 14], ['in', 115],
        ['fr', 16], ['fm', 17], ['cn', 18], ['pt', 19], ['sw', 20], ['sh', 21],
        ['br', 22], ['ki', 23], ['ph', 24], ['mx', 25], ['es', 26], ['bu', 27],
        ['mv', 28], ['sp', 290], ['gb', 300], ['gr', 31], ['as', 32], ['dk', 33],
        ['gl', 34], ['gu', 35], ['mp', 36], ['pr', 37], ['vi', 38], ['ca', 39],
        ['st', 40], ['cv', 41], ['dm', 420], ['nl', 43], ['jm', 44], ['ws', 450],
        ['om', 46], ['vc', 47], ['tr', 48], ['bd', 49], ['lc', 50], ['nr', 510],
        ['no', 52], ['kn', 53], ['bh', 54], ['to', 55], ['fi', 560], ['id', 57],
        ['mu', 580], ['se', 59], ['tt', 600], ['my', 61], ['pa', 62], ['pw', 63],
        ['tv', 64], ['mh', 65], ['cl', 66], ['th', 67], ['gd', 68], ['ee', 69],
        ['ag', 70], ['tw', 710000], ['bb', 72], ['it', 73], ['mt', 74], ['vu', 75],
        ['sg', 76], ['cy', 77], ['lk', 78], ['km', 79], ['fj', 800], ['ru', 81],
        ['va', 82], ['sm', 83], ['kz', 84], ['az', 85], ['tj', 86], ['ls', 87],
        ['uz', 188], ['ma', 189], ['co', 90], ['tl', 910], ['tz', 92], ['ar', 193],
        ['sa', 194], ['pk', 95], ['ye', 96], ['ae', 97], ['ke', 98], ['pe', 99],
        ['do', 100], ['ht', 101], ['pg', 102], ['ao', 103], ['kh', 104],
        ['vn', 105], ['mz', 106], ['cr', 107], ['bj', 108], ['ng', 109],
        ['ir', 110], ['sv', 111], ['sl', 112], ['gw', 113], ['hr', 114],
        ['bz', 115], ['za', 116], ['cf', 117], ['sd', 1118], ['cd', 119],
        ['kw', 120], ['de', 121], ['be', 122], ['ie', 123], ['kp', 124],
        ['kr', 125], ['gy', 126], ['hn', 1127], ['mm', 128], ['ga', 129],
        ['gq', 130], ['ni', 131], ['lv', 132], ['ug', 133], ['mw', 134],
        ['am', 135], ['sx', 136], ['tm', 137], ['zm', 138], ['nc', 139],
        ['mr', 140], ['dz', 141], ['lt', 142], ['et', 143], ['er', 144],
        ['gh', 145], ['si', 1460], ['gt', 147], ['ba', 148], ['jo', 149],
        ...
        ['bw', 1210], ['bs', 211], ['nz', 1212], ['cu', 213], ['ec', 214],
        ['au', 215], ['ve', 1216], ['sb', 1217], ['mg', 218], ['is', 219],
        ['eg', 1220], ['kg', 1221], ['np', 22220]
    ];
